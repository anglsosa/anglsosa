...
HEADERS = {'authorization': 'token '+ os.environ['ACCESS_TOKEN']} if 'ACCESS_TOKEN' in os.environ else {}
USER_NAME = os.environ.get('USER_NAME', 'anglsosa')
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2003, 6, 20))
